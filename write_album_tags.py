...
if len(sys.argv) < 3:
  print '[ERROR] Uso: ' + sys.argv[0] + ' <album-rel-dir> <album-tag>'
  print '        Eje: ' + sys.argv[0] + " \'Uruguay/Buitres/1991 - BDDL1-La Bruja\' \'BDDL1 - La Bruja\'"
  sys.exit(2)
...
for filename in os.listdir(album_full_dir):
	...
	if song_ext == 'm4a':
		...
		audio.save()
		print filename + ' --> [MP4] Album: ' + album_tag
